...
public class Graph {
    ...
    /**
     * V 顶点数 the number of vertices in the graph 
     */
    private final int V;
    /**
     * E 边数 the number of edges in the graph
     */
    private int E;
    
    /**
     * adj 邻接表数组
     * an <em>adjacency-lists representation</em>, which is a vertex-indexed array of {@link Bag} objects.
     */
